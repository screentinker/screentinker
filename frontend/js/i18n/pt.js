...
export default {
  ...
  'playlist.more_matches': 'Mais {n} resultados — refine a busca ou escolha uma pasta',
  'playlist.library_truncated': 'Esta biblioteca é muito grande e não está listada por completo aqui. Use a busca ou uma pasta para encontrar um item.',
  ...
  'power.off_from': 'Tela apagada às',
  'power.on_at': 'Ligar novamente às',
  'power.add_window': 'Adicionar um horário',
  'power.remove_window': 'Remover este horário',
  'power.remove_schedule': 'Remover agendamento',
  'power.save': 'Salvar agendamento',
  'power.no_windows': 'Nenhum horário definido — a tela continua ligada.',
  'power.no_days': 'nenhum dia',
  'power.overnight': '(durante a noite)',
  'power.crosses_midnight': 'Este horário passa da meia-noite até a manhã seguinte.',
  'power.unsupported': 'Algumas telas não conseguem se apagar sozinhas e vão ignorar este agendamento. Você ainda pode salvá-lo.',
  'power.inherited_from_group': 'Esta tela segue o agendamento do grupo. Salvar aqui substitui apenas para esta tela.',
  'power.state.on': 'Tela ligada',
  'power.state.scheduled_off': 'Desligada por agendamento',
  'power.next_off': 'Apaga às {time}',
  'power.next_on': 'Liga novamente às {time}',
  'power.preset.weeknights': 'Dias de semana 22:00–06:00',
  'power.preset.everynight': 'Todas as noites 22:00–06:00',
  'power.preset.weekends': 'Todo o fim de semana',
  'power.saved': 'Agendamento salvo',
  'power.save_failed': 'Não foi possível salvar o agendamento',
  'power.day.sun': 'Dom',
  'power.day.mon': 'Seg',
  'power.day.tue': 'Ter',
  'power.day.wed': 'Qua',
  ...
  'nav.members': 'Membros',
  'common.close': 'Fechar',
  'slides.ai.placeholder': 'Descreva um slide: "promocao de outono, 40% off"',
  'slides.ai.generate': 'Gerar',
  'slides.ai.settings': 'Configuracoes de IA',
  ...
  'switcher.create_hint': 'Um espaco de trabalho e um conjunto separado de telas, playlists e midias dentro da sua organizacao. Os membros sao convidados por espaco.',
  'switcher.create_name_label': 'Nome',
  'switcher.create_name_placeholder': 'ex. Area de vendas',
  'switcher.create_slug_label': 'Slug (opcional, compativel com URL)',
  'switcher.create_slug_hint': 'Minusculas, digitos e hifens. Deve ser unico na organizacao.',
  'switcher.create_submit': 'Criar espaco de trabalho',
  'switcher.create_working': 'Criando...',
  'switcher.create_name_required': 'O nome nao pode ficar vazio',
  'switcher.create_failed': 'Nao foi possivel criar o espaco de trabalho',
  ...
  'dashboard.select_all': 'Todos', 'dashboard.invert_selection': 'Inverter', 'dashboard.cancel_selection': 'Cancelar', 'dashboard.remove_from_group': 'Remover do grupo', 'dashboard.add_to_group': 'Adicionar ao grupo', 'dashboard.create_group_and_add': 'Criar e adicionar ao grupo',
  ...
  'content.filter_type_bundle': 'Pacote HTML',
  'content.type_bundle': 'Pacote HTML',
  'content.type_bundle_short': 'Pacote',
  'content.bundle_entry': 'Comeca em {entry}',
  'content.bundle_skipped': '{n} arquivo(s) nao puderam ser incorporados: video e audio precisam ser vinculados.',
  'content.bundle_preview_failed': 'Nao foi possivel renderizar esse pacote',
  ...
  'widget.picker.upload': 'Enviar imagem',
  'widget.picker.drop_hint': 'Ou arraste uma imagem para aqui.',
  'widget.picker.uploading': 'Enviando…',
  'widget.picker.uploading_pct': 'Enviando… {pct} %',
  'widget.picker.upload_failed': 'Falha no envio',
  'widget.picker.not_an_image': 'Aqui só é possível usar arquivos de imagem.',
  'widget.picker.no_images': 'Ainda não há imagens — envie uma ou arraste-a para aqui.',
  ...
  // --- 2.0.1: checklist inicial, novidades ---
  'gs.playlist.cta_here': 'Adicionar conteúdo',
  'gs.assign.desc': 'Abra a tela onde quer que o conteúdo seja exibido, clique em Playlist, escolha o seu layout; se não estiver em tela cheia, selecione onde o conteúdo deve ser exibido e clique em Publicar.',
  'gs.assign.cta_here': 'Escolher playlist',
  'whatsnew.title': 'Novidades da versão {version}',
  'whatsnew.dismiss': 'Fechar',
  'whatsnew.full_notes': 'Notas completas',
  'whatsnew.history_title': 'Novidades',
  'whatsnew.version_line': '{version} — {date}',
  'whatsnew.version_current': '{version} — {date} (em execução)',
  'onboarding.step.done.assign_label': 'O que esta tela deve exibir?',
  'onboarding.step.done.assign_none': 'Nada por enquanto',
  'onboarding.toast.playlist_assigned': 'Playlist atribuída',
  'onboarding.toast.assign_failed': 'Não foi possível atribuir essa playlist',
  'onboarding.toast.publish_failed': 'Não foi possível publicar a playlist, portanto nada seria exibido ainda',
};
