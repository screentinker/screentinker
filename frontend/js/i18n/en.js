...
export default {
  ...
  'dashboard.ws_set_server_url': 'Change server URL',
  ...
  'dashboard.ws_set_server_url_prompt': 'New server URL for EVERY device in this workspace. Each panel verifies it is reachable and only switches if so:',
  'dashboard.ws_set_server_url_confirm': 'Point every device in this workspace at {url}? Panels that cannot reach it keep their current server. This affects the whole workspace.',
