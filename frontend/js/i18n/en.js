...
export default {
  ...
  'widget.trans.scope_next': 'The next item only',
  'widget.trans.scope_all': 'Every item (playlist default)',
  'widget.trans.scope_hint': 'Place this between two items to control the crossover into the one after it. “Every item” sets a default for the whole playlist.',
