...
export default {
  ...
  'dashboard.group_sync.hint': "Play this group's shared playlist in lockstep across its displays — items start and end together. Requires a playlist assigned to the group; a display on a different playlist is ignored.",
  'dashboard.group_sync.leader_auto': 'Leader: Auto',
  'dashboard.group_sync.leader_hint': 'The display that drives the timing. Auto picks the first online member and self-heals if it drops; pin one to always lead when it is online.',
  'dashboard.group_sync.toast_on': 'Synchronized playback enabled',
  'dashboard.group_sync.toast_off': 'Synchronized playback disabled',
  'dashboard.group_sync.toast_leader': 'Sync leader pinned',
  'dashboard.group_sync.toast_leader_auto': 'Sync leader set to auto',
