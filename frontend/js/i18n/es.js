...
export default {
  ...
  'playlist.folders_empty_hidden': '{n} carpetas vacías ocultas',
  'playlist.folder_label': 'Filtrar por carpeta',
  'playlist.folder_all': 'Todas las carpetas',
  'playlist.folder_root': 'Sin carpeta',
  'playlist.more_matches': '{n} coincidencias más: afina la búsqueda o elige una carpeta',
  'playlist.library_truncated': 'Esta biblioteca es muy grande, así que no se muestra entera. Usa la búsqueda o una carpeta para encontrar un elemento.',
  ...
  'slides.ai.generate': 'Generar',
  'slides.ai.settings': 'Ajustes de IA',
  ...
  'switcher.create_hint': 'Un espacio de trabajo es un conjunto separado de pantallas, listas y medios dentro de tu organizacion. Los miembros se invitan por espacio.',
  'switcher.create_name_label': 'Nombre',
  'switcher.create_name_placeholder': 'p. ej. Planta de tienda',
  'switcher.create_slug_label': 'Slug (opcional, apto para URL)',
  'switcher.create_slug_hint': 'Minusculas, digitos y guiones. Debe ser unico en la organizacion.',
  'switcher.create_submit': 'Crear espacio de trabajo',
  'switcher.create_working': 'Creando...',
  'switcher.create_name_required': 'El nombre no puede estar vacio',
  'switcher.create_failed': 'No se pudo crear el espacio de trabajo',
  ...
  'dashboard.select_all': 'Todo', 'dashboard.invert_selection': 'Invertir', 'dashboard.cancel_selection': 'Cancelar', 'dashboard.remove_from_group': 'Quitar del grupo', 'dashboard.add_to_group': 'Añadir al grupo', 'dashboard.create_group_and_add': 'Crear y añadir al grupo',
  ...
  'content.filter_type_bundle': 'Paquete HTML',
  'content.type_bundle': 'Paquete HTML',
  'content.type_bundle_short': 'Paquete',
  'content.bundle_entry': 'Empieza en {entry}',
  'content.bundle_skipped': '{n} archivo(s) no se pudieron incrustar: el video y el audio deben enlazarse.',
  'content.bundle_preview_failed': 'No se pudo representar ese paquete',
  ...
  'widget.picker.upload': 'Subir imagen',
  'widget.picker.drop_hint': 'O arrastra una imagen aquí.',
  'widget.picker.uploading': 'Subiendo…',
  'widget.picker.uploading_pct': 'Subiendo… {pct} %',
  'widget.picker.upload_failed': 'Error al subir',
  'widget.picker.not_an_image': 'Aquí solo se pueden usar archivos de imagen.',
  'widget.picker.no_images': 'Aún no hay imágenes: sube una o arrástrala aquí.',
  ...
  // --- 2.0.1: checklist de inicio, novedades ---
  'gs.playlist.cta_here': 'Añadir contenido',
  'gs.assign.desc': 'Abre la pantalla en la que quieras reproducir el contenido, haz clic en Lista de reproducción, elige tu diseño; si no usas pantalla completa, indica dónde quieres que se reproduzca el contenido y haz clic en Publicar.',
  'gs.assign.cta_here': 'Elegir lista de reproducción',
  'whatsnew.title': 'Novedades de la versión {version}',
  'whatsnew.dismiss': 'Cerrar',
  'whatsnew.full_notes': 'Notas completas',
  'whatsnew.history_title': 'Novedades',
  'whatsnew.version_line': '{version} — {date}',
  'whatsnew.version_current': '{version} — {date} (en ejecución)',
  'onboarding.step.done.assign_label': '¿Qué debe reproducir esta pantalla?',
  'onboarding.step.done.assign_none': 'Nada por ahora',
  'onboarding.toast.playlist_assigned': 'Lista de reproducción asignada',
  'onboarding.toast.assign_failed': 'No se pudo asignar esa lista de reproducción',
  'onboarding.toast.publish_failed': 'No se pudo publicar la lista de reproducción, así que aún no se reproduciría nada',
};
