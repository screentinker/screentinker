...
export default {
  ...
  'playlist.more_matches': 'Altri {n} risultati — affina la ricerca o scegli una cartella',
  'playlist.library_truncated': 'Questa libreria è molto grande e non viene elencata per intero. Usa la ricerca o una cartella per trovare un elemento.',
  ...
  'power.off_from': 'Schermo spento alle',
  'power.on_at': 'Riacceso alle',
  'power.add_window': 'Aggiungi un orario',
  'power.remove_window': 'Rimuovi questo orario',
  'power.remove_schedule': 'Rimuovi programmazione',
  'power.save': 'Salva programmazione',
  'power.no_windows': 'Nessun orario impostato — lo schermo resta acceso.',
  'power.no_days': 'nessun giorno',
  'power.overnight': '(notturno)',
  'power.crosses_midnight': 'Questo intervallo prosegue oltre la mezzanotte fino al mattino seguente.',
  'power.unsupported': 'Alcuni schermi non possono spegnersi da soli e ignoreranno questa programmazione. Puoi comunque salvarla.',
  'power.inherited_from_group': 'Questo schermo segue la programmazione del suo gruppo. Salvando qui la sostituisci solo per questo schermo.',
  'power.state.on': 'Schermo acceso',
  'power.state.scheduled_off': 'Spento come da programmazione',
  'power.next_off': 'Si spegne alle {time}',
  'power.next_on': 'Si riaccende alle {time}',
  'power.preset.weeknights': 'Nei giorni feriali 22:00–06:00',
  'power.preset.everynight': 'Ogni notte 22:00–06:00',
  'power.preset.weekends': 'Tutto il fine settimana',
  'power.saved': 'Programmazione salvata',
  'power.save_failed': 'Impossibile salvare la programmazione',
  'power.day.sun': 'Dom',
  'power.day.mon': 'Lun',
  'power.day.tue': 'Mar',
  'power.day.wed': 'Mer',
  ...
  'slides.ai.generate': 'Genera',
  'slides.ai.settings': 'Impostazioni IA',
  ...
  'switcher.create_hint': 'Uno spazio di lavoro e un insieme separato di schermi, playlist e media nella tua organizzazione. I membri vengono invitati per spazio.',
  'switcher.create_name_label': 'Nome',
  'switcher.create_name_placeholder': 'es. Area vendita',
  'switcher.create_slug_label': 'Slug (facoltativo, adatto agli URL)',
  'switcher.create_slug_hint': "Minuscole, cifre, trattini. Deve essere unico nell'organizzazione.",
  'switcher.create_submit': 'Crea spazio di lavoro',
  'switcher.create_working': 'Creazione...',
  'switcher.create_name_required': 'Il nome non puo essere vuoto',
  'switcher.create_failed': 'Impossibile creare lo spazio di lavoro',
  ...
  'dashboard.select_all': 'Tutti', 'dashboard.invert_selection': 'Inverti', 'dashboard.cancel_selection': 'Annulla', 'dashboard.remove_from_group': 'Rimuovi dal gruppo', 'dashboard.add_to_group': 'Aggiungi al gruppo', 'dashboard.create_group_and_add': 'Crea e aggiungi al gruppo',
  ...
  'widget.picker.upload': 'Carica immagine',
  'widget.picker.drop_hint': "Oppure trascina qui un'immagine.",
  'widget.picker.uploading': 'Caricamento…',
  'widget.picker.uploading_pct': 'Caricamento… {pct} %',
  'widget.picker.upload_failed': 'Caricamento non riuscito',
  'widget.picker.not_an_image': 'Qui si possono usare solo file immagine.',
  'widget.picker.no_images': 'Nessuna immagine: caricane una o trascinala qui.',
  ...
  // --- 2.0.1: checklist iniziale, novità ---
  'gs.playlist.cta_here': 'Aggiungi contenuti',
  'gs.assign.desc': 'Apri lo schermo su cui vuoi riprodurre i contenuti, fai clic su Playlist, scegli il layout; se non usi lo schermo intero, indica dove vuoi che i contenuti vengano riprodotti e fai clic su Pubblica.',
  'gs.assign.cta_here': 'Scegli playlist',
  'whatsnew.title': 'Novità della versione {version}',
  'whatsnew.dismiss': 'Chiudi',
  'whatsnew.full_notes': 'Note complete',
  'whatsnew.history_title': 'Novità',
  'whatsnew.version_line': '{version} — {date}',
  'whatsnew.version_current': '{version} — {date} (in esecuzione)',
  'onboarding.step.done.assign_label': 'Che cosa deve riprodurre questo schermo?',
  'onboarding.step.done.assign_none': 'Ancora niente',
  'onboarding.toast.playlist_assigned': 'Playlist assegnata',
  'onboarding.toast.assign_failed': 'Impossibile assegnare quella playlist',
  'onboarding.toast.publish_failed': 'Impossibile pubblicare la playlist, quindi non verrebbe ancora riprodotto nulla',
};
