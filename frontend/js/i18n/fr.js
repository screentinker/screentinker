...
export default {
  ...
  'playlist.more_matches': '{n} autres résultats — affinez la recherche ou choisissez un dossier',
  'playlist.library_truncated': 'Cette bibliothèque est très grande, elle n’est donc pas affichée en entier. Utilisez la recherche ou un dossier pour trouver un élément.',
  ...
  'slides.ai.generate': 'Generer',
  'slides.ai.settings': 'Parametres IA',
  'slides.ai.working': 'Generation...',
  'slides.ai.need_prompt': "Indiquez d'abord ce que la diapositive doit dire",
  'slides.ai.done': '{n} elements generes - enregistrez seulement si cela vous convient',
  'slides.ai.moved_on': "La diapositive a change pendant la generation, rien n'a ete remplace",
  'slides.ai.failed': 'Impossible de generer cette diapositive',
  'slides.ai.replace_warn': 'Cela remplace tout sur la diapositive actuelle.',
  'switcher.create_title': 'Nouvel espace de travail',
  'switcher.create_hint': "Un espace de travail est un ensemble distinct d'ecrans, de playlists et de medias dans votre organisation. Les membres sont invites par espace.",
  'switcher.create_name_label': 'Nom',
  'switcher.create_name_placeholder': 'p. ex. Surface de vente',
  'switcher.create_slug_label': 'Slug (facultatif, compatible URL)',
  'switcher.create_slug_hint': "Minuscules, chiffres, traits d'union. Doit etre unique dans l'organisation.",
  'switcher.create_submit': 'Creer un espace de travail',
  'switcher.create_working': 'Creation...',
  'switcher.create_name_required': 'Le nom ne peut pas etre vide',
  'switcher.create_failed': "Impossible de creer l'espace de travail",
  ...
  'dashboard.select_all': 'Tout', 'dashboard.invert_selection': 'Inverser', 'dashboard.cancel_selection': 'Annuler', 'dashboard.remove_from_group': 'Retirer du groupe', 'dashboard.add_to_group': 'Ajouter au groupe', 'dashboard.create_group_and_add': 'Créer et ajouter au groupe',
  ...
  'content.bundle_entry': 'Demarre sur {entry}',
  'content.bundle_skipped': "{n} fichier(s) n'ont pas pu etre integres : la video et l'audio doivent etre lies.",
  'content.bundle_preview_failed': "Impossible d'afficher ce bundle",
  ...
  'widget.picker.upload': 'Téléverser une image',
  'widget.picker.drop_hint': 'Ou déposez une image ici.',
  'widget.picker.uploading': 'Téléversement…',
  'widget.picker.uploading_pct': 'Téléversement… {pct} %',
  'widget.picker.upload_failed': 'Échec du téléversement',
  'widget.picker.not_an_image': 'Seuls les fichiers image peuvent être utilisés ici.',
  'widget.picker.no_images': "Aucune image pour l'instant — téléversez-en une ou déposez-la ici.",
  ...
  // --- 2.0.1 : checklist de démarrage, nouveautés, listes imbriquées, déclencheurs ---
  'dashboard.create_wall': "Créer un mur d'écrans",
  'dashboard.selection_count_other': "{n} écrans sélectionnés",
  'gs.playlist.cta_here': "Ajouter du contenu",
  'gs.assign.desc': "Ouvrez l'écran sur lequel vous voulez diffuser le contenu, cliquez sur Liste de lecture, choisissez votre disposition ; si vous n'êtes pas en plein écran, indiquez où le contenu doit s'afficher, puis cliquez sur Publier.",
  'gs.assign.cta_here': "Choisir une liste de lecture",
  'common.error': "Une erreur est survenue.",
  'dashboard.toast.added_to_group_one': "1 écran ajouté au groupe",
  'dashboard.toast.added_to_group_other': "{n} écrans ajoutés au groupe",
  'dashboard.toast.removed_from_group_one': "1 écran retiré du groupe",
  'dashboard.toast.removed_from_group_other': "{n} écrans retirés du groupe",
  'device.playlist.inherited_from': "Hérité de {name}",
  'device.playlist.inherited_generic': "Hérité",
  'device.playlist.overridden': "Défini pour cet écran",
  'device.playlist.overridden_tip': "Cet écran a sa propre liste de lecture. Son groupe ou son mur ne la modifiera pas.",
  'device.playlist.inherited_tip': "Cet écran suit {name}. Modifier cette liste de lecture modifie cet écran.",
  'device.playlist.revert': "Utiliser l'héritage",
  'device.playlist.revert_tip': "Ne plus imposer de liste — revenir à celle dont cet écran hérite.",
  'device.toast.playlist_reverted': "Retour à la liste de lecture héritée",
  'playlist.tab_playlists': "Listes de lecture",
  'playlist.item_nested': "Liste de lecture",
  'playlist.tag_nested': "Contient une liste de lecture",
  'playlist.contains_tip': "Cette liste de lecture en contient déjà une autre : elle ne peut donc pas être ajoutée à une liste.",
  'playlist.plays_through': "lue en entier",
  'playlist.nested_duration_hint': "Chaque élément de la liste incluse est lu, chacun selon sa propre durée.",
  'playlist.nest_draft_note': "pas encore publiée",
  'playlist.no_playlists_nestable': "Aucune liste de lecture ne peut être ajoutée ici. Une liste qui en contient déjà une autre ne peut pas être imbriquée à nouveau — l'imbrication est limitée à un niveau.",
  'playlist.nest_blocked_one': "Cette liste de lecture est déjà utilisée dans une autre : elle ne peut donc pas en contenir une. L'imbrication est limitée à un niveau.",
  'playlist.nest_blocked_other': "Cette liste de lecture est déjà utilisée dans {n} autres : elle ne peut donc pas en contenir une. L'imbrication est limitée à un niveau.",
  'playlist.used_by_one': "utilisée dans 1",
  'playlist.used_by_other': "utilisée dans {n}",
  'playlist.used_by_tip_one': "Incluse dans 1 autre liste de lecture. Retirez-la de celle-ci avant de la supprimer.",
  'playlist.used_by_tip_other': "Incluse dans {n} autres listes de lecture. Retirez-la de celles-ci avant de la supprimer.",
  'playlist.n_items_one': "1 élément",
  'playlist.n_items_other': "{n} éléments",
  'whatsnew.title': "Nouveautés de la version {version}",
  'whatsnew.dismiss': "Fermer",
  'whatsnew.full_notes': "Notes complètes",
  'whatsnew.history_title': "Nouveautés",
  'whatsnew.version_line': "{version} — {date}",
  'whatsnew.version_current': "{version} — {date} (version en cours)",
  'onboarding.step.done.assign_label': "Que doit diffuser cet écran ?",
  'onboarding.step.done.assign_none': "Rien pour l'instant",
  'onboarding.toast.playlist_assigned': "Liste de lecture attribuée",
  'onboarding.toast.assign_failed': "Impossible d'attribuer cette liste de lecture",
  'onboarding.toast.publish_failed': "Impossible de publier la liste de lecture : rien ne serait diffusé pour le moment",
  'nav.triggers': "Déclencheurs",
  'trigger.intro': "Permet à un système externe — un pupitre Crestron ou Extron, un automate, un bouton — d'afficher une liste de lecture par-dessus ce que montre un écran. La résolution se fait sur l'écran lui-même, donc cela continue de fonctionner sans Internet.",
  'trigger.empty': "Aucun déclencheur pour l'instant.",
  'trigger.new': "Nouveau déclencheur",
  'trigger.edit': "Modifier le déclencheur",
  'trigger.name': "Nom",
  'trigger.tokens': "Déclenchement / arrêt",
  'trigger.match_token': "Jeton de déclenchement",
  'trigger.clear_token': "Jeton d'arrêt",
  'trigger.token_hint': "Le texte exact envoyé par le système externe. Lettres, chiffres et ponctuation — pas d'espaces, car il est transmis sur une seule ligne.",
  'trigger.target': "Diffuse",
  'trigger.target_hint': "La liste de lecture à afficher. Ses médias sont téléchargés et conservés sur chaque écran concerné, afin que le déclencheur fonctionne aussi hors ligne.",
  'trigger.target_missing': "(liste de lecture supprimée)",
  'trigger.mode': "Mode",
  'trigger.mode_once': "Lire une fois",
  'trigger.mode_until_cleared': "Maintenir jusqu'à l'arrêt",
  'trigger.max_duration': "Durée maximale (secondes)",
  'trigger.max_duration_hint': "Limite de sécurité pour la lecture unique. 0 signifie lire toute la liste. Si la liste est plus longue que la limite, la limite l'emporte.",
  'trigger.lease': "Arrêt automatique après (secondes)",
  'trigger.lease_hint': "Facultatif. S'arrête de lui-même si l'émetteur cesse de répéter le déclencheur. Chaque répétition le renouvelle.",
  'trigger.lease_risk': "Pas d'arrêt automatique : si le message d'arrêt se perd, cet écran conserve la superposition jusqu'à une intervention manuelle.",
  'trigger.lease_risk_banner': "Un ou plusieurs déclencheurs se maintiennent jusqu'à l'arrêt via UDP, sans arrêt automatique. Si un message d'arrêt se perd, ces écrans restent couverts jusqu'à une intervention manuelle.",
  'trigger.no_lease': "pas d'arrêt automatique",
  'trigger.priority': "Priorité",
  'trigger.sources': "Accepte",
  'trigger.enabled': "Activé",
  'trigger.disabled': "Désactivé",
  'trigger.assign': "Écrans",
  'trigger.sec_identity': "Déclencheur",
  'trigger.sec_match': "Ce qui le déclenche",
  'trigger.sec_shows': "Ce qu'il affiche",
  'trigger.sec_behaviour': "Son comportement",
  'trigger.no_published': "Aucune liste de lecture publiée à afficher. Un déclencheur diffuse une liste que les écrans ont déjà téléchargée : publiez-en une d'abord — une liste non publiée n'afficherait rien.",
  'trigger.unpublished_hidden_one': "{n} liste de lecture non publiée n'est pas proposée : un déclencheur ne peut afficher qu'une liste déjà téléchargée par les écrans.",
  'trigger.unpublished_hidden_other': "{n} listes de lecture non publiées ne sont pas proposées : un déclencheur ne peut afficher qu'une liste déjà téléchargée par les écrans.",
  'trigger.assign_hint': "C'est l'attribution d'un déclencheur qui fait qu'un écran télécharge et conserve sa liste de lecture. Un déclencheur non attribué ne se déclenche jamais.",
  'trigger.assigned': "Écrans",
  'trigger.unassigned': "Non attribué",
  'trigger.groups': "Groupes",
  'trigger.none_available': "Aucun disponible.",
  'trigger.saved': "Déclencheur enregistré",
  'trigger.deleted': "Déclencheur supprimé",
  'trigger.confirm_delete': "Supprimer ce déclencheur ?",
  'device.trigcfg.title': "Déclencheurs — paramètres d'écoute",
  'device.trigcfg.intro': "Permet à un système de commande de ce réseau local d'interrompre la liste de lecture. Les deux portes sont fermées tant que vous ne les ouvrez pas, et rien ne fonctionne sans secret partagé.",
  'device.trigcfg.accept_http': "Accepter HTTP",
  'device.trigcfg.accept_udp': "Accepter UDP",
  'device.trigcfg.group_ph': "groupe multicast (239.x.x.x)",
  'device.trigcfg.clear_all_ph': "jeton d'arrêt général",
  'device.trigcfg.save': "Enregistrer les paramètres",
  'device.trigcfg.secret': "Secret partagé",
  'device.trigcfg.secret_unset': "non défini — les déclencheurs ne peuvent pas fonctionner",
  'device.trigcfg.secret_note': "L'intégrateur le saisit dans son système de commande. Tout ce qui, sur ce réseau local, le connaît peut changer ce qu'affiche cet écran.",
  'device.trigcfg.generate': "Générer",
  'device.trigcfg.rotate': "Renouveler",
  'device.trigcfg.rotate_confirm': "Renouveler le secret partagé ? Tout système de commande déjà configuré avec l'ancien cessera de fonctionner jusqu'à sa mise à jour.",
  'device.trigcfg.saved_live': "Enregistré — l'écran l'a reçu",
  'device.trigcfg.saved_queued': "Enregistré — l'écran est hors ligne et le récupérera à sa reconnexion",
  'device.trig.title': "Déclencheurs",
  'device.trig.none_seen': "Rien n'est encore parvenu à cet écran — soit rien n'a été envoyé, soit cela n'arrive pas jusqu'ici.",
  'device.trig.arriving_refused': "Des messages parviennent BIEN à cet écran mais sont refusés — vérifiez le jeton et le secret partagé, pas le réseau.",
  'device.trig.working': "Les déclencheurs arrivent et sont acceptés.",
  'device.trig.self_ok': "autotest : entend son propre groupe",
  'device.trig.self_fail': "autotest : n'entend pas son propre groupe",
  'device.trig.rejoins': "{n} reconnexions au groupe",
  'device.trig.counts': "{received} reçus · {accepted} acceptés · {rejected} refusés",
  'device.trig.last_seen': "dernier message {when}",
  'device.trig.definitions': "{n} déclencheur(s) sur cet écran",
  'device.trig.showing': "Affiche « {name} » (via {source})",
  'device.trig.join_error': "Impossible de rejoindre le groupe : {err}",
};
